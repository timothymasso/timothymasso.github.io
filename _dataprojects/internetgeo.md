...
Now that the base dataset and visualization system are complete, future work could include adding international data or creating a **time-lapse view** of incident trends over the decades. The final site has no formatting lol.
